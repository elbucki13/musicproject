...
for z in range(40,len(billboardname)):
    ...
    if my_file.is_file():
        print('' + chartlist + ' with YT Links.txt exists')
        continue
    try:
        ...
        for y in range(len(eb['entries'])):
            try:
                ...
                try:
                    ...
                    eb["entries"][y]['youtubeLink'] = 'cant find youtubeLink'
                    eb["entries"][y]['youtubeTitle'] = 'cant find youtubeTitle'
                    currentTitle.append('cant find')
                    currentLinks.append('cant find')
                try:
            ...
            if not SPO_ID:
                try:
                    ...
                    eb["entries"][y]['spotifyLink'] = 'https://embed.spotify.com/?uri=spotify:track:' + SPOO
